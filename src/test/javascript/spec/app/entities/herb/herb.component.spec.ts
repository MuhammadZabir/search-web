...
import { HerbComponent } from 'app/entities/herb/herb.component';
import { HerbService } from 'app/entities/herb/herb.service';
import { Herb } from 'app/shared/model/herb.model';

describe('Component Tests', () => {
    describe('Herb Management Component', () => {
        let comp: HerbComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HerbComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.herbs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
