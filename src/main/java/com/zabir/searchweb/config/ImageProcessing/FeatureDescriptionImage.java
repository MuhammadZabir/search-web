package com.zabir.searchweb.config.ImageProcessing;
...
public class FeatureDescriptionImage {
    ...
    private void computeMatches() { // To find matches using FLANN
    ...
    private void describeFeature() { // Not gonna use it cause this is intended for testing purposes to visualize if the matches correct or not
        computeMatches() ;
